...
SEED: list[dict] = [
    ...
    dict(server_id="npm:@modelcontextprotocol_server-filesystem", name="Filesystem", transport="stdio",
    ...
    dict(server_id="npm:@modelcontextprotocol_server-github", name="GitHub", transport="stdio",
    ...
    dict(server_id="npm:@modelcontextprotocol_server-memory", name="Memory (knowledge graph)", transport="stdio",
    ...
    dict(server_id="npm:@modelcontextprotocol_server-fetch", name="Fetch", transport="stdio",
    ...
    dict(server_id="npm:@modelcontextprotocol_server-puppeteer", name="Puppeteer (browser)", transport="stdio",
    ...
    dict(server_id="npm:@modelcontextprotocol_server-everything", name="Everything", transport="stdio",
    ...
    dict(server_id="npm:@modelcontextprotocol_server-sequential-thinking", name="Sequential Thinking", transport="stdio",
    ...
    dict(server_id="npm:@modelcontextprotocol_server-time", name="Time", transport="stdio",
         command=NPX, args=["-y", "@modelcontextprotocol/server-time"], registry="npm",
         url="https://github.com/modelcontextprotocol/servers", auth="none", deep=1,
         version="0.6.2", desc="Time and timezone utilities."),
    dict(server_id="npm:@modelcontextprotocol_server-brave-search", name="Brave Search", transport="stdio",
    ...
    dict(server_id="npm:@modelcontextprotocol_server-slack", name="Slack", transport="stdio",
    ...
    dict(server_id="npm:@modelcontextprotocol_server-postgres", name="Postgres", transport="stdio",
    ...
    dict(server_id="npm:@modelcontextprotocol_server-sqlite", name="SQLite", transport="stdio",
         command=NPX, args=["-y", "@modelcontextprotocol/server-sqlite"], registry="npm",
         url="https://github.com/modelcontextprotocol/servers", auth="none", deep=0,
         version="0.6.2", desc="SQLite database exploration + queries."),
    dict(server_id="npm:@modelcontextprotocol_server-git", name="Git", transport="stdio",
         command=NPX, args=["-y", "@modelcontextprotocol/server-git"], registry="npm",
         url="https://github.com/modelcontextprotocol/servers", auth="none", deep=0,
         version="0.6.2", desc="Git repository operations."),
    dict(server_id="npm:@modelcontextprotocol_server-google-maps", name="Google Maps", transport="stdio",
    ...
    dict(server_id="npm:@modelcontextprotocol_server-websearch", name="WebSearch (MCP org)", transport="stdio",
         command=NPX, args=["-y", "@modelcontextprotocol/server-websearch"], registry="npm",
         url="https://github.com/modelcontextprotocol/servers", auth="api_key", deep=0,
         version="0.6.2", desc="Web search (requires API key)."),
    dict(server_id="npm:@modelcontextprotocol_server-sentry", name="Sentry", transport="stdio",
    ...
    dict(server_id="npm:@modelcontextprotocol_server-google-drive", name="Google Drive", transport="stdio",
         command=NPX, args=["-y", "@modelcontextprotocol/server-google-drive"], registry="npm",
         url="https://github.com/modelcontextprotocol/servers", auth="oauth", deep=0,
         version="0.6.2", desc="Google Drive files and search."),
    dict(server_id="npm:@modelcontextprotocol_server-linear", name="Linear", transport="stdio",
         command=NPX, args=["-y", "@modelcontextprotocol/server-linear"], registry="npm",
         url="https://github.com/modelcontextprotocol/servers", auth="api_key", deep=0,
         version="0.6.2", desc="Linear issue tracking."),
    dict(server_id="npm:@modelcontextprotocol_server-firecrawl", name="Firecrawl", transport="stdio",
    ...
    dict(server_id="npm:@upstash_redis-mcp", name="Upstash Redis", transport="stdio",
    ...
    dict(server_id="npm:@modelcontextprotocol_server-aws-kb-retrieval", name="AWS KB Retrieval", transport="stdio",
    ...
    dict(server_id="npm:@executeautomation_playwright-mcp-server", name="Playwright Automation", transport="stdio",
    ...
    dict(server_id="npm:@modelcontextprotocol_server-servers-registry", name="Servers Registry", transport="stdio",
    ...
    dict(server_id="npm:@aws-sdk_mcp-server", name="AWS SDK Resources", transport="stdio",
    ...
    dict(server_id="npm:@elsoul_solc-mcp-server", name="Solc (Solidity)", transport="stdio",
    ...
    dict(server_id="npm:@zereight_mcp-server-azure-devops", name="Azure DevOps", transport="stdio",
    ...
    dict(server_id="npm:@hackmd_mcp-server", name="HackMD", transport="stdio",
    ...
    dict(server_id="npm:@pab1it0_adb-mcp-server", name="ADB (Android)", transport="stdio",
    ...
    dict(server_id="npm:@anthropic_mcp-server-nightly", name="Anthropic MCP", transport="stdio",
    ...
    dict(server_id="npm:@chenzhe0712_mcp-server-bilibili", name="Bilibili", transport="stdio",
    ...
    dict(server_id="npm:@multiwoven_mcp-server", name="Multiwoven", transport="stdio",
    ...
    dict(server_id="npm:@tavily-ai_tavily-mcp", name="Tavily Search", transport="stdio",
    ...
    dict(server_id="npm:@vscode_mcp-server", name="VS Code", transport="stdio",
    ...
    dict(server_id="npm:@docker_mcp-server", name="Docker", transport="stdio",
    ...
    dict(server_id="npm:@kubernetes-mcp-server_core", name="Kubernetes", transport="stdio",
    ...
    dict(server_id="npm:@recteurl_vmcp-server", name="vMCP", transport="stdio",
    ...
    dict(server_id="npm:@hexagonai_mcp_server", name="Hexagon AI", transport="stdio",
    ...
    dict(server_id="npm:@automatalabs_mcp-server-automata", name="Automata", transport="stdio",
    ...
    dict(server_id="npm:@xmcp_mcp-server-stripe", name="Stripe", transport="stdio",
...
DEEP_TEST_IDS = [
    "mock:mock-mcp",
    "npm:@modelcontextprotocol_server-everything",
...
def seed_registry(force: bool = False, deep_ids: Optional[list[str]] = None) -> dict:
    ...
    deep_ids = [d.replace('/', '_') for d in (deep_ids or DEEP_TEST_IDS)]
    added = updated = 0
    for entry in SEED:
        sid = entry["server_id"]
