...
CURATED: dict[str, list[tuple[str, float, str]]] = {
    ...
    "npm:@modelcontextprotocol_server-filesystem:read_file": [("filesystem.read", 1.0, "curated")],
    "npm:@modelcontextprotocol_server-filesystem:read_directory": [("filesystem.read", 1.0, "curated")],
    "npm:@modelcontextprotocol_server-filesystem:write_file": [("filesystem.write", 1.0, "curated")],
    "npm:@modelcontextprotocol_server-github:create_issue": [("repository.issue.create", 1.0, "curated")],
    "npm:@modelcontextprotocol_server-github:search_repositories": [("repository.read", 1.0, "curated"), ("web.search", 0.5, "curated")],
